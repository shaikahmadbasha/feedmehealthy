 ...
 *
 */
@Component("getMenuItemsProcessor")
public class GetMenuItemsProcessor extends BaseProcessor {

	private static Logger logger = Logger.getLogger(GetMenuItemsProcessor.class);
	...
	public Object processRequest(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			responseMap.put(ResponseConstants.menuItems.value(), mealDAO.getMenuItems());
